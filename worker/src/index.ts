...
import serviceSolutionRoutes from "./routes/serviceSolution.routes";
...
app.route("/service-categories", serviceCategoryRoutes);
app.route("/solutions", solutionRoutes);
app.route("/service-solutions", serviceSolutionRoutes);
